...
@section('title', 'Data Dokumen Penjualan Aset')
    ...
    <div class="content-header">
        <div class="d-flex justify-content-between">
            ...
            <div class="d-flex justify-content-between mb-2">
                <a href="{{ route('dashboard.sales.create') }}" class="btn btn-primary">
                    Tambah Dokumen Penjualan Aset
                </a>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($sales as $data)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('dashboard.sales.show', $data->id) }}" class="btn btn-primary">
                                    <i class="fas fa-eye"></i>
                                </a>
                                {{-- <a href="{{ route('dashboard.sales.edit', $data->id) }}"
                                    class="btn btn-primary btn">Edit</a> --}}
                                <form action="{{ route('dashboard.sales.destroy', $data->id) }}" method="post"
