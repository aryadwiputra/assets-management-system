...
@section('content')
    ...
    <div class="content-header">
        <div class="d-flex justify-content-between">
            ...
            <a href="{{ route('dashboard.warranties.create') }}"
                ...
                <tbody>
                    @foreach ($warranties as $data)
                        <tr>
                            ...
                            <td>{{ $data->period }}</td>
                            <td>
                                <a href="{{ route('dashboard.warranties.edit', $data->id) }}"
                                    class="btn btn-primary btn">Edit</a>
                                <form action="{{ route('dashboard.warranties.destroy', $data->id) }}" method="post"
