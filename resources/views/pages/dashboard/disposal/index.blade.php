    ...
    <div class="content-header">
        <div class="d-flex justify-content-between">
            ...
            <div class="d-flex justify-content-between mb-2">
                <a href="{{ route('dashboard.disposals.create') }}" class="btn btn-primary">
                    Tambah Disposal
                </a>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($disposals as $data)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('dashboard.disposals.show', $data->id) }}" class="btn btn-primary">
                                    <i class="fas fa-eye"></i>
                                </a>
                                {{-- <a href="{{ route('dashboard.disposals.edit', $data->id) }}"
                                    class="btn btn-primary btn">Edit</a> --}}
                                <form action="{{ route('dashboard.disposals.destroy', $data->id) }}" method="post"
