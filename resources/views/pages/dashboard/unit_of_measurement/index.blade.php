...
@section('title', 'Satuan Unit Aset')
                ...
                <tbody>
                    @foreach ($uom as $data)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('dashboard.unit-of-measurement.edit', $data->id) }}"
                                    class="btn btn-primary btn">Edit</a>
                                <form action="{{ route('dashboard.unit-of-measurement.destroy', $data->id) }}" method="post"
